...
{
	m_pickupSolenoid1 = new frc::Solenoid(c_compressorPCMid, c_pickupSolenoidChannel1);
	m_pickupSolenoid2 = new frc::Solenoid(c_compressorPCMid, c_pickupSolenoidChannel2);
   // m_timer = new Timer();
}
...
{
    if (m_position == kDown) {
           frc::SmartDashboard::PutString("Claw Position", "Down");
       } else {
           frc::SmartDashboard::PutString("Claw Position", "Up");
       }
}
